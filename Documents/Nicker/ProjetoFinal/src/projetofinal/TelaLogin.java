...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(chercaLogin(txtlogin.getText(),new String(txtsenha.getPassword()))){

            Introgas sc = new Introgas();
            sc.setVisible(true);

            JOptionPane.showMessageDialog(null,"Realizado com Sucesso !","Exêto!",JOptionPane.INFORMATION_MESSAGE);

        }   else{
            JOptionPane.showMessageDialog(null," Opa... Informações incorretas !","Error!",JOptionPane.ERROR_MESSAGE);
        }

    }//GEN-LAST:event_jButton1ActionPerformed

    public boolean chercaLogin(String login,String senha){
        return login.equals("java")&& senha.equals("1234");
    }    
